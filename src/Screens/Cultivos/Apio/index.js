...
import Header from '../../../Assets/Img/HeadersCultivos/apio.png';
import {EBios} from '../../../Constants/Icons/logos';
import {ColorBar, Footer} from '../../../Components/Cultivos';

export default class Apio extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={styles.redFrame}>
            <Text style={{textAlign: 'justify'}}>
              ● Recuperación rápida de la planta después de cada corte.{'\n'}
              {'\n'}● Mayor número de cortes (espinaca y apio). {'\n'}
              {'\n'}● Uniformización de cosecha en lechugas.{'\n'}
              {'\n'}● Mayor tamaño, firmeza y vida de anaquel. {'\n'}
          ...
          <View style={{flex: 1, padding: 15, paddingBottom: 0}}>
            <Text style={{textAlign: 'justify'}}>
              ...
              {'\n'}
              {'\n'}De 500 / 750 ml aplicar dosis baja cuando la planta tenga de
              6 a 8 hojas y repetir a los 15 días la dosis alta.
            </Text>
          </View>
          <EBios style={{width: 120, height: 120}} />
          <Footer
            url={
              'http://161.35.105.244/ficha/APIO%20ESPINACA%20LECHUGA%20CHRONOS%20EBIOS.pdf'
            }
          />
        </View>
      </ScrollView>
