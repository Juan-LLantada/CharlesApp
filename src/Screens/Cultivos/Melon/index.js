...
import Header from '../../../Assets/Img/HeadersCultivos/melon.png';
        ...
        <View style={styles.container}>
          ...
          <View style={{flex: 1, padding: 15, paddingBottom: 0}}>
            <Text style={{textAlign: 'justify'}}>
              ...
              {'\n'}
              {'\n'}• Aplicar 500 ml al inicio de la floración y realizar de 2 a
              3 aplicaciones con intervalos de 10-15 días.{' '}
            </Text>
          </View>
          <EBios style={{width: 120, height: 120}} />
          <Footer
            url={'http://161.35.105.244/ficha/MELON%20EBIOS%20CHRONOS.pdf'}
          />
        </View>
      </ScrollView>
    );
