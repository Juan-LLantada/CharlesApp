...
import Header from '../../../Assets/Img/HeadersCultivos/ornamentales.png';
import {EBios} from '../../../Constants/Icons/logos';
import {ColorBar, Footer} from '../../../Components/Cultivos';

export default class Ornamentales extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
        ...
        <View style={styles.container}>
          ...
          <View style={styles.redFrame}>
            <Text style={{textAlign: 'justify'}}>
              ...
              {'\n'}● Uniformización y anticipación de la brotación.{'\n'}
              {'\n'}● Flores de mayor tamaño.{'\n'}
              {'\n'}● Disminución del doblamiento del tallo (mayor turgencia de
              tallos). {'\n'}
              {'\n'}● Mantenimiento de color por más tiempo. {'\n'}
              {'\n'}● Menor caída de pétalos. {'\n'}
            </Text>
          </View>
          <ColorBar />
          <View style={{flex: 1, padding: 15, paddingBottom: 0}}>
            <Text style={{textAlign: 'justify'}}>
              ...
              {'\n'}
              {'\n'}• 500 ml al inicio de la brotación de yemas o después del
              desbotone (pinch), repetir cada 15 días hasta 30 días antes de
              corte.{' '}
            </Text>
          </View>
          <EBios style={{width: 120, height: 120}} />
          <Footer
            url={
              'http://161.35.105.244/ficha/ORNAMENTALES%20EBIOS%20CHRONOS.pdf'
            }
          />
        </View>
      </ScrollView>
