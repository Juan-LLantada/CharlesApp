...
import Header from '../../../Assets/Img/HeadersCultivos/calabacita.png';
import {EBios} from '../../../Constants/Icons/logos';
import {ColorBar, Footer} from '../../../Components/Cultivos';

export default class Calabaza extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
        ...
        <View style={styles.container}>
          ...
          <View style={{flex: 1, padding: 15, paddingBottom: 0}}>
            <Text style={{textAlign: 'justify'}}>
              ...
              {'\n'}
              {'\n'}Aplicar 500 ml al inicio de la floración y realizar de 2 a 3
              aplicaciones con intervalos de 10-15 días.
            </Text>
          </View>
          <EBios style={{width: 120, height: 120}} />
          <Footer
            url={'http://161.35.105.244/ficha/CALABAZA%20EBIOS%20CHRONOS.pdf'}
          />
        </View>
      </ScrollView>
    );
