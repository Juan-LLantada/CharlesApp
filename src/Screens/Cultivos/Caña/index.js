...
import Header from '../../../Assets/Img/HeadersCultivos/cana.png';
import {EBios} from '../../../Constants/Icons/logos';
import {ColorBar, Footer} from '../../../Components/Cultivos';

export default class Caña extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={styles.redFrame}>
            <Text style={{textAlign: 'justify'}}>
              ● Definen el amacollamiento y rendimiento de la caña. {'\n'}
              {'\n'}● Aumenta la sacarosa, anto en variedades tempranas como
              tardías.
            </Text>
          </View>
          <ColorBar />
          <View style={{flex: 1, padding: 15, paddingBottom: 0}}>
            <Text style={{textAlign: 'justify'}}>
              ...
              {'\n'}
              {'\n'}Aplicar 1/2 L entre los 40 a los 75 días después de
              emergida. {'\n'}
              {'\n'}
              1/2 L a los dos meses antes de cosecha y mínimo a los 30 días
              antes de cosecha, una 2da aplicación, lo cual en las variedades
              tempranas sería en la semana 36 y en las variedades tardías de la
              semana 44 a la 48.
            </Text>
          </View>
          <EBios style={{width: 120, height: 120}} />
          <Footer url={'http://161.35.105.244/ficha/canaebios.pdf'} />
        </View>
      </ScrollView>
    );
  }
