...
import Header from '../../../Assets/Img/HeadersCultivos/limon.png';
import {EBios} from '../../../Constants/Icons/logos';
import {ColorBar, Footer, LemonTable} from '../../../Components/Cultivos';
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={styles.redFrame}>
            <Text style={{textAlign: 'justify'}}>
              ● Evita la sobremaduración. {'\n'}
              {'\n'}● Mantenimiento del verde. {'\n'}
              {'\n'}● Más frutos cosechados al disminuir el aborto floral.{' '}
              {'\n'}
              {'\n'}● Disminuye el rompimiento estilar: Es la presencia de
              humedad en el ápice del fruto que mancha de color café brillante
              el pezón del fruto.
            </Text>
          </View>
          <ColorBar />
          <View style={{flex: 1, padding: 15, paddingBottom: 0}}>
            <Text style={{textAlign: 'justify'}}>
              ...
              {'\n'}
              {'\n'}
              Chronos Life® se puede mezclar con fungicidas y fertilizantes
              foliares ya que cuenta con un pH ácido lo que le permite ser
              aplicado con los productos de nutrición y protección vegetal.
            </Text>
          </View>
          <LemonTable />
          <EBios style={{width: 120, height: 120}} />
          <Footer
            url={'http://161.35.105.244/ficha/LIMON%20EBIOS%20CHRONOS.pdf'}
          />
        </View>
      </ScrollView>
    );
