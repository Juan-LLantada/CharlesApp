...
import Header from '../../../Assets/Img/HeadersCultivos/trigo.png';
        ...
        <View style={styles.container}>
          ...
          <View style={styles.redFrame}>
            <Text style={{textAlign: 'justify'}}>
              ...
              {'\n'}● Mejor amacollamiento. {'\n'}
              {'\n'}● Mejor llenado de grano. {'\n'}
              {'\n'}● Mayor concentracion de proteínas que le dá mas calidad al
              grano. {'\n'}
            </Text>
          </View>
          <ColorBar />
          <View style={{flex: 1, padding: 15, paddingBottom: 0}}>
            <Text style={{textAlign: 'justify'}}>
              ...
              {'\n'}
              {'\n'}• 500 en la etapa del amacollamiento y la segunda aplicacion
              al embuche{' '}
            </Text>
          </View>
          <EBios style={{width: 120, height: 120}} />
          <Footer
            url={'http://161.35.105.244/ficha/TRIGO%20EBIOS%20CHRONOS.pdf'}
          />
        </View>
      </ScrollView>
    );
