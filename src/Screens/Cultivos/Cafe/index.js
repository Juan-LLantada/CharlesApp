...
import Header from '../../../Assets/Img/HeadersCultivos/cafe.png';
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={styles.redFrame}>
            <Text style={{textAlign: 'justify'}}>
              • Recupera rápidamente la planta de café después de la cosecha.{' '}
              {'\n'}
              {'\n'}• Dsminuye sustancialmente la caída de “cerezas” aumentando
              la carga en la bandola.{'\n'}
              {'\n'}• Uniformiza la cosecha para dar menos cortes.
            </Text>
          </View>
          <View style={{padding: 10, width: '100%'}}>
            <Text
              ...
              UNIFORMIZACIÓN DE COSECHA DE CAFÉ, CON CALIDAD DE EXPORTACIÓN.
            </Text>
          </View>
          <ColorBar />
          <View style={{flex: 1, padding: 15, paddingBottom: 0, width: '100%'}}>
            <Text style={{textAlign: 'justify'}}>
              <Text style={{textAlign: 'justify', fontWeight: 'bold'}}>
                DOSIS{' '}
              </Text>
              {'\n'}
              {'\n'}1/2 lt después de la cosecha. {'\n'}
              {'\n'}
              1/2 lt a la caída de pétalos. {'\n'}
              {'\n'}
              1/2 lt a los 90 días después del primer amarre.
            </Text>
          </View>
          <EBios style={{width: 120, height: 120}} />
          <Footer
            url={'http://161.35.105.244/ficha/CAFE%20CHRONOS%20EBIOS.pdf'}
          />
        </View>
      </ScrollView>
    );
