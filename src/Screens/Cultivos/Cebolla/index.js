...
import Header from '../../../Assets/Img/HeadersCultivos/cebolla.png';
import {EBios} from '../../../Constants/Icons/logos';
import {ColorBar, Footer} from '../../../Components/Cultivos';

export default class Cebolla extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={styles.redFrame}>
            <Text style={{textAlign: 'justify'}}>
              ● Recuperación mas rápida a factores abióticos oxidativos.{'\n'}
              {'\n'}● Mayor tamaño de bulbos.{'\n'}
              {'\n'}● Mayor vida de anaquel.{'\n'}
              {'\n'}● Favorece el cierre de bulbos.
            </Text>
          </View>
          <ColorBar />
          <View style={{flex: 1, padding: 15, paddingBottom: 0}}>
            <Text style={{textAlign: 'justify'}}>
              ...
              {'\n'}
              {'\n'}0.5 lt/ha al inicio de formación de bulbo y realizar dos
              aplicaciones más con intervalos de cada 15 días.
            </Text>
          </View>
          <EBios style={{width: 120, height: 120}} />
          <Footer
            url={'http://161.35.105.244/ficha/CEBOLLA%20EBIOS%20CHRONOS.pdf'}
          />
        </View>
      </ScrollView>
    );
