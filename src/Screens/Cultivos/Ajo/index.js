...
export default class Ajo extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={styles.redFrame}>
            <Text style={{textAlign: 'justify'}}>
              • Incremento del tamaño de bulbo. {'\n'}
              {'\n'}• Disminución de disturbios fisiológicos asociados a la
              sobre maduración (dientes cerosos - waxy breakdown) • Mayor
              concentración de alicina, betacaroteno y otros compuestos
              antioxidantes lo cual significa mayor calidad. {'\n'}
              {'\n'}• Hojas más verdes al momento de cosecha que disminuyen la
              presión de enfermedades. {'\n'}
              {'\n'}• Favorece el cierre del bulbo.
            </Text>
          </View>
          <ColorBar />
          <View style={{flex: 1, padding: 15, paddingBottom: 0}}>
            <Text style={{textAlign: 'justify'}}>
              ...
              {'\n'}
              {'\n'}500 ml la primera aplicacion al inicio del crecimiento del
              bulbo y las 3 siguientes aplicaciones de 10 a 15 días después de
              la inmediata anterior.
            </Text>
          </View>
          <EBios style={{width: 120, height: 120}} />
          <Footer
            url={'http://161.35.105.244/ficha/AJO%20EBIOS%20CHRONOS.pdf'}
          />
        </View>
      </ScrollView>
    );
