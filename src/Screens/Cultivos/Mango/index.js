...
import Header from '../../../Assets/Img/HeadersCultivos/mango.png';
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={styles.redFrame}>
            <Text style={{textAlign: 'justify'}}>
              {'\n'}● Aumenta el tiempo de vida de la inflorescencia, esto
              significa que hay mayor tiempo de polinización y fecundación de la
              flor, generando más amarre de frutos.{'\n'}
              {'\n'}● Aumenta el tiempo de receptividad de la flor hermafrodita,
              para ser polinizada y fecundada (disminución de la dicogamia
              protogínica), lo cual se traduce en más frutos cosechados. Chronos
              Life ® contiene nutrientes y poliaminas en perfecto balance que
              logran:{'\n'}
              {'\n'}● Disminución del aborto de frutos.{'\n'}
              {'\n'}● Aumenta el número de frutos amarrados por panícula floral.
              {'\n'}
              {'\n'}● Más frutos de mayor calibre por corte.{'\n'}
              {'\n'}● Frutos de calidad postcosecha para mercados distantes ya
              que regula la dinámica del etileno que nos da mayor vida de
              anaquel.{'\n'}
          ...
          <View style={{flex: 1, padding: 15, paddingBottom: 0}}>
            <Text style={{textAlign: 'justify'}}>
              ...
              {'\n'}
              {'\n'}• En prefloración aplicar Chronos Life ® a dosis de 3/4 L
              por Ha cada 10 a 15 días. Acompañar esta aplicación con los
              nutrientes fósforo, calcio, zinc y boro. {'\n'}• En floración
              aplicar Chronos Life ® a dosis de 3/4 a 1 L por Ha y repetir la
              aplicación 3 semanas después. {'\n'}• En fructificación aplicar
              Chronos Life ® a dosis de 1/2 L por Ha hasta el 1er tercio del
              fruto. Acompañar esta aplicación con los nutrientes potasio,
              calcio y zinc.{' '}
            </Text>
          </View>
          <EBios style={{width: 120, height: 120}} />
          <Footer
            url={'http://161.35.105.244/ficha/MANGO%20EBIOS%20CHRONOS.pdf'}
          />
        </View>
      </ScrollView>
    );
