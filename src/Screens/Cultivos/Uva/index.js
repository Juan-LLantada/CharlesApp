...
import Header from '../../../Assets/Img/HeadersCultivos/uvas.png';
        ...
        <View style={styles.container}>
          ...
          <View style={styles.redFrame}>
            <Text style={{textAlign: 'justify'}}>
              ...
              {'\n'}● Brotación más uniforme. {'\n'}
              {'\n'}● Brotes más vigorosos. {'\n'}
              {'\n'}● Mayor cuajado del racimo. {'\n'}
              {'\n'}● Mayor uniformidad de frutos. {'\n'}
              {'\n'}● Uvas de mayor calibre . {'\n'}
              {'\n'}● Maduración uniforme. {'\n'}
              {'\n'}● Mayor consistencia de fruto y vida de anaquel.{'\n'}
            </Text>
          </View>
          <ColorBar />
          <View style={{flex: 1, padding: 15, paddingBottom: 0}}>
            <Text style={{textAlign: 'justify'}}>
              ...
              {'\n'}
              {'\n'}• 1000 ml para uniformizar la brotación y darle vigor al
              brote, repetir en la formación del racimo hasta floración.{' '}
            </Text>
          </View>
          <EBios style={{width: 120, height: 120}} />
          <Footer
            url={'http://161.35.105.244/ficha/UVA%20EPSILON%20CHRONOS.pdf'}
          />
        </View>
      </ScrollView>
    );
