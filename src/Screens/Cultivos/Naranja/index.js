...
import Header from '../../../Assets/Img/HeadersCultivos/naranja.png';
import {EBios} from '../../../Constants/Icons/logos';
import {ColorBar, Footer} from '../../../Components/Cultivos';
export default class Naranja extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={styles.redFrame}>
            <Text style={{textAlign: 'justify'}}>
              {'\n'}● Frutos de mayor tamaño y firmeza.{'\n'}
              {'\n'}● Menor deshidratación del fruto.{'\n'}
              {'\n'}● Mayor vida de anaquel. {'\n'}
              {'\n'}● Mayor grados brix y jugo {'\n'}
            </Text>
          </View>
          <ColorBar />
          <View style={{flex: 1, padding: 15, paddingBottom: 0}}>
            <Text style={{textAlign: 'justify'}}>
              ...
              {'\n'}
              {'\n'}• 750 / 1000 ml aplicar 15 días antes de la floración, al
              inicio de la floración y repetir a los 15 días después del amarre
              y posteriormente cada 30 días hasta un mes antes de corte.{' '}
            </Text>
          </View>
          <EBios style={{width: 120, height: 120}} />
          <Footer
            url={
              'http://161.35.105.244/ficha/NARANJA,%20MANDARINA,%20TORONJA%20CHRONOS%20EBIOS.pdf'
            }
          />
        </View>
      </ScrollView>
