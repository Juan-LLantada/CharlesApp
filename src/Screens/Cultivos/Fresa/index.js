...
import Header from '../../../Assets/Img/HeadersCultivos/fresas.png';
import {EBios} from '../../../Constants/Icons/logos';
import {ColorBar, Footer} from '../../../Components/Cultivos';

export default class Fresa extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={styles.redFrame}>
            <Text style={{textAlign: 'justify'}}>
              ● Disminución del estrés oxidativo provocado por condiciones
              climáticas, fisiológicas y nutricionales dentro del túnel.{'\n'}
              {'\n'}● Plantas con mayor número de brotes reproductivos.{'\n'}
              {'\n'}● Disminución del aborto.{'\n'}
              {'\n'}● Uniformización de la maduración.{'\n'}
              {'\n'}● Mayores tamaños.{'\n'}
          ...
          <EBios style={{width: 120, height: 120}} />
          <Footer
            url={'http://161.35.105.244/ficha/FRESAS%20EPSILON%20CHRONOS.pdf'}
          />
        </View>
      </ScrollView>
    );
