...
import Header from '../../../Assets/Img/HeadersCultivos/brocoli.png';
import {EBios} from '../../../Constants/Icons/logos';
import {ColorBar, Footer} from '../../../Components/Cultivos';

export default class Brocoli extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={styles.redFrame}>
            <Text style={{textAlign: 'justify'}}>
              • Uniformización de cosecha en brocolí. {'\n'}
              {'\n'}• Mayor tamaño. {'\n'}
              {'\n'}• Mayor firmeza.{'\n'}
          ...
          <View style={{flex: 1, padding: 15, paddingBottom: 0}}>
            <Text style={{textAlign: 'justify'}}>
              ...
              {'\n'}
              {'\n'}500 ml aplicar cuando la planta inicie la formación de
              cabeza y repetir a los 15 días después con un máximo de 4
              aplicaciones hasta 15 días antes del corte.
            </Text>
          </View>
          <EBios style={{width: 120, height: 120}} />
          <Footer
            url={'http://161.35.105.244/ficha/BROCOLI%20EPSILON%20CHRONOS.pdf'}
          />
        </View>
      </ScrollView>
    );
