...
import Header from '../../../Assets/Img/HeadersCultivos/zanahoria.png';
import {EBios} from '../../../Constants/Icons/logos';
import {ColorBar, Footer} from '../../../Components/Cultivos';

export default class Zanahoria extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
        ...
        <View style={styles.container}>
          ...
          <View style={styles.redFrame}>
            <Text style={{textAlign: 'justify'}}>
              ...
              {'\n'}● Mantenimiento de la dinámica de crecimiento de la
              zanahoria. {'\n'}
              {'\n'}● Planta con mayor vida productiva que le permite mayor
              tamaño a la zanahoria. {'\n'}
              {'\n'}● Mayor acumulación de azucares en la zanahoria.{'\n'}
            </Text>
          </View>
          <ColorBar />
          <View style={{flex: 1, padding: 15, paddingBottom: 0}}>
            <Text style={{textAlign: 'justify'}}>
              ...
              {'\n'}
              {'\n'}• 500 ml aplicar cuando la planta se encuentre en pleno
              desarrollo vegetativo y repetir cada 15 días hasta 15 antes del
              corte.{' '}
            </Text>
          </View>
          <EBios style={{width: 120, height: 120}} />
          <Footer
            url={'http://161.35.105.244/ficha/ZANAHORIA%20CHRONOS%20EBIOS.pdf'}
          />
        </View>
      </ScrollView>
    );
