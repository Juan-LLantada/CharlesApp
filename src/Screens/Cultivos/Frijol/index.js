...
import Header from '../../../Assets/Img/HeadersCultivos/granos.png';
import {EBios} from '../../../Constants/Icons/logos';
import {ColorBar, Footer} from '../../../Components/Cultivos';

export default class Frijol extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={styles.redFrame}>
            <Text style={{textAlign: 'justify'}}>
              ● En aplicaciones previas a floración se incrementa el número de
              brazos.{'\n'}
              {'\n'}● A mayor número de brazos hay mayor inducción floral.{'\n'}
              {'\n'}● Aumenta el flujo de reservas hacia las vainas. disminución
              de amarillamiento temprano de la planta.
            </Text>
          </View>
          <ColorBar />
          <View style={{flex: 1, padding: 15, paddingBottom: 0}}>
            <Text style={{textAlign: 'justify'}}>
              ...
              {'\n'}
              {'\n'}500 ml realizar la primera aplicación en la etapa de
              formación de brazos, la segunda en botón floral y la tercera, al
              inicio del crecimiento de las vainas.
            </Text>
          </View>
          <EBios style={{width: 120, height: 120}} />
          <Footer
            url={
              'http://161.35.105.244/ficha/FRIJOL,%20SOYA%20Y%20GRABANZO%20CHRONOS%20EBIOS.pdf'
            }
          />
        </View>
      </ScrollView>
