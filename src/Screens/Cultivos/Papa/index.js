...
import Header from '../../../Assets/Img/HeadersCultivos/papa.png';
...
export default class Papa extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
        ...
        <View style={styles.container}>
          ...
          <View style={styles.redFrame}>
            <Text style={{textAlign: 'justify'}}>
              ...
              {'\n'}● Mayor número de tubérculos por parición.{'\n'}
              {'\n'}● Homogeneidad en parición primaria y secundarias . {'\n'}
              {'\n'}● Mayor producción de primeras y segundas. {'\n'}
              {'\n'}● Vida de anaquel y resistencia al transporte. {'\n'}
              {'\n'}● En adoras y variedades tempranas, no hay deformación de
              tubérculo (moneo). {'\n'}
            </Text>
          </View>
          <ColorBar />
          <View style={{flex: 1, padding: 15, paddingBottom: 0}}>
            <Text style={{textAlign: 'justify'}}>
              ...
              {'\n'}
              {'\n'}• 500 ml en la estolonización, en la tuberización y en
              crecimiento de tubérculos.{' '}
            </Text>
          </View>
          <Image source={FooterPapa} style={{width: width - 20, height: 230}} />
          <EBios style={{width: 120, height: 120}} />
          <Footer
            url={'http://161.35.105.244/ficha/PAPA%20EBIOS%20CHRONOS.pdf'}
          />
        </View>
      </ScrollView>
    );
