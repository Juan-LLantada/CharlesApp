...
import Header from '../../../Assets/Img/HeadersCultivos/alfalfa.png';
import {EBios} from '../../../Constants/Icons/logos';
import {ColorBar, Footer} from '../../../Components/Cultivos';

export default class Alfalfa extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={styles.redFrame}>
            <Text style={{textAlign: 'justify'}}>
              ● Mayor área foliar por metro2. {'\n'}
              {'\n'}● Mayores lecturas de clorofila. {'\n'}
              {'\n'}● Alfalfas con una mayor concentración de proteínas. {'\n'}
              {'\n'}Se mejora el ensilado para un mayor valor alimenticio.
            </Text>
          </View>
          <ColorBar />
          <View style={{flex: 1, padding: 15, paddingBottom: 0}}>
            <Text style={{textAlign: 'justify'}}>
              ...
              {'\n'}
              {'\n'}500 ml al inicio del crecimiento vegetativo y repetir
